...
filepath1 = filedir+prefix1+"_"+horOrVert+".dat"
filepath2 = filedir+prefix2+"_"+horOrVert+".dat"
SkipToStep = 0
...
MagName=filedir+"/MagneticEnergy.dat"
...
#   cbar_ax2 = fig.add_axes([0.55, 0.15, 0.03, 0.4])
    ...
    outputname = outputdir+"/"+"everything"+"%04d"%(t+offset)+".png"
